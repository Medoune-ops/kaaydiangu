...
function LoginForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const result = await signIn("credentials", {
      email: identifier, // On envoie l'identifiant (email ou matricule) dans le champ 'email'
      password,
      redirect: false,
    });
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#020c1b] px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-[440px] relative z-10">
        ...
        <div className="relative glass-dark p-8 animate-slide-up-delay-1 border border-white/10">
          ...
          <Suspense fallback={<div className="h-[200px] flex items-center justify-center text-white/50">Chargement...</div>}>
            <LoginForm />
          </Suspense>
        </div>

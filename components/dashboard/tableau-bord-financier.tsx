        ...
        <div className="relative flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-emerald-100 text-sm mt-1">
              ...
              {" "}· Solde net{" "}
              <span className={`font-bold ${data.solde_net >= 0 ? "text-white" : "text-red-300"}`}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        {kpis.map((kpi) => (
          ...
          >
            ...
            <div className="text-[1.6rem] font-black tracking-[-0.03em] text-slate-900 leading-none tabular-nums mb-2 break-all">
              {kpi.value}
            </div>
            <div>{kpi.badge}</div>
          </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-100/80 shadow-[0_1px_4px_rgba(15,23,42,0.06),0_4px_16px_rgba(15,23,42,0.04)] overflow-hidden">
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-50">
          <div className="flex items-center gap-2.5">
            ...
            <h3 className="text-[0.875rem] font-bold text-slate-800 tracking-tight">Recettes vs Dépenses</h3>
          </div>
          ...
          <div className="flex flex-wrap items-end gap-4">
            <div>
              ...
              <select
                ...
                className="h-9 bg-slate-50 border border-slate-200 rounded-lg px-3 text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-400 transition-all"
              >
            ...
            <div>
              ...
              <input
                ...
                className="h-9 w-24 bg-slate-50 border border-slate-200 rounded-lg px-3 text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-400 transition-all"
              />
            </div>
            <button
              onClick={exportExcel}
              className="h-9 px-4 text-sm font-semibold text-slate-700 bg-white border border-slate-200 rounded-lg hover:bg-slate-50 hover:border-slate-300 transition-all inline-flex items-center gap-2"
            >
              <Download size={14} />
              Excel (.xlsx)
            </button>
            <button
              ...
              className="h-9 px-4 bg-indigo-500 text-white text-sm rounded-lg font-semibold hover:bg-indigo-600 transition-all inline-flex items-center gap-2 shadow-sm shadow-indigo-500/20"
            >
              <FileText size={14} />
              Bilan PDF
            </button>
